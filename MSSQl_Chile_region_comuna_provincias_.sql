...
select count(*) as comunasCargadas from [dbo].[comunas]
select count(*) as provinciasCargadas from [dbo].[provincias]
select count(*) as regionesCargadas from  [dbo].[regiones]